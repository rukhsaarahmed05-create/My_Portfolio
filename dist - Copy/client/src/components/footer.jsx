      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <button onClick={() => scrollToSection("#projects")} className="text-slate-400 hover:text-white transition-colors">
                  Projects
                </button>
              </li>
              <li>
                <button onClick={() => scrollToSection("#blog")} className="text-slate-400 hover:text-white transition-colors">
                  Blog
                </button>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-slate-400 hover:text-white transition-colors">Research Papers</a></li>
              <li><a href="#" className="text-slate-400 hover:text-white transition-colors">Code Samples</a></li>
              <li><a href="#" className="text-slate-400 hover:text-white transition-colors">Datasets</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-slate-700 mt-8 pt-8 text-center">
          <p className="text-slate-400">
            © 2023 ML Vision Portfolio. All rights reserved. Built with modern web technologies.
          </p>
        </div>
      </div>
    </footer>);
