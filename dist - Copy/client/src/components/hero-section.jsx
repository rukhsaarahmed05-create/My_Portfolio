...
function HeroSection() {
    ...
    return (<section id="home" className="pt-24 pb-16 lg:pt-32 lg:pb-24">
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-12 items-center">
          <div className="mb-10 lg:mb-0">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button_1.Button onClick={scrollToProjects} className="bg-brand-600 hover:bg-brand-700 text-white px-8 py-3 rounded-lg font-medium">
                View Projects
              </button_1.Button>
              <button_1.Button variant="outline" className="border border-slate-300 dark:border-slate-600 text-slate-900 dark:text-slate-100 hover:bg-slate-100 dark:hover:bg-slate-800 px-8 py-3 rounded-lg font-medium">
                Download Resume
              </button_1.Button>
            </div>
          </div>
            ...
            <div className="relative h-96 lg:h-[500px] bg-gradient-to-br from-brand-500 to-violet-600 rounded-2xl overflow-hidden">
              <div className="absolute inset-0 opacity-20">
                <div className="grid grid-cols-8 h-full">
                  {Array.from({ length: 8 }).map((_, i) => (<div key={i} className="border-r border-white/20 h-full"></div>))}
                </div>
              </div>
